...
describe("Percent.encode", () => {
  ...
  it("encode(Uint8Array, {encodeSet:[]})", () => {
    expect(Percent.encode(Uint8Array.of(), {encodeSet:[]})).toBe("");
    expect(Percent.encode(Uint8Array.of(3,2,1,0,0xFF,0xFE,0xFD,0xFC), {encodeSet:[]})).toBe("%03%02%01%00%FF%FE%FD%FC");
    expect(Percent.encode(utf8Bytes1, {encodeSet:[]})).toBe("1%00 !~%7F%E3%81%82+");
    expect(Percent.encode(Uint8Array.of(255), {encodeSet:[]})).toBe("%FF");
    expect(Percent.encode(Uint8Array.of(0), {encodeSet:[]})).toBe("%00");
    expect(Percent.encode(Uint8Array.of(0,32,65), {encodeSet:[]})).toBe("%00 A");
    expect(Percent.encode(Uint8Array.of(255), {encodeSet:[]})).toBe("%FF");
  ...
  it("encode(Uint8Array, {encodeSet:[...]})", () => {
    ...
    expect(Percent.encode(Uint8Array.of(), op)).toBe("");
    expect(Percent.encode(utf8Bytes1, op)).toBe("1%00%20!~%7F%E3%81%82+");
  ...
  it("encode(Uint8Array, {encodeSet:[...]})", () => {
    ...
    expect(Percent.encode(Uint8Array.of(), op)).toBe("");
    expect(Percent.encode(utf8Bytes1, op)).toBe("1%00%20!~%7F%E3%81%82%2B");
    expect(Percent.encode(Uint8Array.of(0,32,65), op)).toBe("%00%20A");
    expect(Percent.encode(Uint8Array.of(255), op)).toBe("%FF");

    expect(Percent.encode(utf8Bytes1, op)).toBe(globalThis.encodeURIComponent("1\u{0} !~\u{7F}あ+"));
    ...
    expect(Percent.encode(x1, op)).toBe(globalThis.encodeURIComponent(x1b));

    expect(Percent.encode(x2bUtf8, op)).toBe(globalThis.encodeURIComponent(x2b));
  ...
  it("encode(Uint8Array, {encodeSet:[...],spaceAsPlus:true})", () => {
    ...
    expect(Percent.encode(Uint8Array.of(), op)).toBe("");
    expect(Percent.encode(utf8Bytes1, op)).toBe("1%00+%21%7E%7F%E3%81%82%2B");
    expect(Percent.encode(Uint8Array.of(0,32,65), op)).toBe("%00+A");
    expect(Percent.encode(Uint8Array.of(255), op)).toBe("%FF");

    const usp = new URLSearchParams();
    usp.set("p1", "1\u{0} !~\u{7F}あ+");
    expect(Percent.encode(utf8Bytes1, op)).toBe(usp.toString().substring(3));

    const u = new URL("http://example.com/");
    u.searchParams.set("p1", x2b);
    const e = u.search.replace("?p1=", "");
    expect(Percent.encode(x2bUtf8, op)).toBe(e);
